...
#SBATCH --job-name=climate-data-creation-2
#SBATCH --output=climate-data-creation-2.log
#SBATCH --error=climate-data-creation-2.log
...
VLLM_LOG="$ROOT/vllm_qwen3_30b_2.log"
...
SAMPLES_PER_SEED=1
N_THREADS=128
HF_REPO="xxx/climate-news-synthetic-seed-44"   # xxx = your HF username / org for uploading generated shards
...
OUTPUT_FILE_LIST=(
    \"$ROOT/data/climatenews_2000_filtered_synthetic_2.jsonl\"
    \"$ROOT/data/climatenews_2005_filtered_synthetic_2.jsonl\"
    \"$ROOT/data/climatenews_2017_filtered_synthetic_2.jsonl\"
    \"$ROOT/data/climatenews_2022_filtered_synthetic_2.jsonl\"
)
