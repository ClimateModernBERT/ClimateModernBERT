...
def get_args():
    parser = argparse.ArgumentParser(description="Generate synthetic environmental science data")
    parser.add_argument("--input_dir", type=str, default="../seed/EnvironmentalScience")
    parser.add_argument("--output_file", type=str, default="synthetic_environmental_science.jsonl")
...
def main():
    ...
    print("✅ Successfully generated synthetic environmental science articles!")
    print("📊 Statistics:")
