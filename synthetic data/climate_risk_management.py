...
def get_args():
    parser = argparse.ArgumentParser(description="Generate synthetic climate risk management data")
    parser.add_argument("--input_dir", type=str, default="../seed/ClimateRiskManagement")
    parser.add_argument("--output_file", type=str, default="synthetic_climate_risk_management.jsonl")
...
def main():
    ...
    print("✅ Successfully generated synthetic climate risk management articles!")
    print("📊 Statistics:")
