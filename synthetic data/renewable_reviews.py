...
def get_args():
    parser = argparse.ArgumentParser(description="Generate synthetic renewable reviews data")
    parser.add_argument("--input_dir", type=str, default="../seed/RenewableReviews")
    parser.add_argument("--output_file", type=str, default="synthetic_renewable_reviews.jsonl")
...
def main():
    ...
    print("✅ Successfully generated synthetic renewable reviews articles!")
    print("📊 Statistics:")
