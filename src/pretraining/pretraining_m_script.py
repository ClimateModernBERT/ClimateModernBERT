...
# Set WANDB_API_KEY in your shell environment before running.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default='/cluster/project/sachan/ClimateModernBert/modernbert_climate/modernbert-base-local')
