...
def get_args():
    parser = argparse.ArgumentParser(description="Generate synthetic weather/climate extremes data")
    parser.add_argument("--input_dir", type=str, default="../seed/WeatherClimateExtreme")
    parser.add_argument("--output_file", type=str, default="synthetic_weather_climate_extreme.jsonl")
...
def main():
    ...
    print("✅ Successfully generated synthetic weather/climate extremes articles!")
    print("📊 Statistics:")
